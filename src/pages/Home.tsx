      ...
      <div className="container mx-auto px-4 flex flex-col-reverse lg:flex-row justify-evenly items-center gap-8">
        <div className="data w-full md:max-w-[700px]">
          ...
          <div className="buttons flex flex-col md:flex-row gap-4 mt-6 justify-center  items-center">
            <Link to="/contact" className="bg-primary font-semibold border-3 border-primary p-3 px-10 text-xl md:text-2xl text-white rounded-xl w-full md:w-auto text-center cursor-pointer">{t('servicesHero')}</Link>
            <Link to="/services" className="border-3 border-primary font-semibold p-3 px-8 text-xl md:text-2xl text-primary rounded-xl w-full md:w-auto text-center">{t('contact')}</Link>
          </div>
        </div>
